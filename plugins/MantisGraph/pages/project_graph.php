...
/**
 * This page displays charts on projects
 *
 * @package MantisBT
...
$t_metrics = create_project_summary( $t_filter );
...
if( count( $t_metrics ) > $t_num_slices ) {
	...
	$t_others = sprintf(
		plugin_lang_get( 'other_projects' ),
		count( $t_metrics ) - $t_num_slices
	);
	$t_pie_metrics[$t_others] = 0;

	# Sum remaining projects into "others" slice
	...
	<div class="widget-box widget-color-blue2">
		<div class="widget-header widget-header-small">
			<h4 class="widget-title lighter">
				...
				<?php echo plugin_lang_get( 'graph_project_title' ) ?>
			</h4>
		</div>
